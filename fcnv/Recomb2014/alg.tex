...
\subfigure[Overall HMM architecture]{
	\includegraphics[height=0.3\textheight]{figures/main-HMM}
	\quad
}
\hspace{20pt}
\subfigure[States for normal inheritance]{
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[height=0.3\textheight]{figures/NOR-HMM}
		\vspace{8pt}
	\end{minipage}	
}
...
\subfigure[States for maternal duplication]{
	\includegraphics[height=0.3\textheight]{figures/DUP-HMM}
	\quad
}
\hspace{0pt}
\subfigure[States for maternal deletion]{
	\begin{minipage}[b]{0.4\textwidth}
		\centering
		\includegraphics[height=0.3\textheight]{figures/DEL-HMM}
	\end{minipage}	
}
