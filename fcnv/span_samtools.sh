...
do
    ...
    samtools mpileup -f $ref -uDSI -Q10 -q10 -l $pos $reads_file | bcftools view -g - > $prefix.$num.vcf &
done
...
do
    reads_file_var=reads$num
    reads_file=${!reads_file_var}
    samtools mpileup -Q10 -q10 -l $valid_regions $reads_file | awk '{print $2,$4}' > $pile_prefix.$num.txt &
done
