...
\geq 3k bp
\end{align*}
These distance bins were empirically estimated from SNP positions in chromosome 1, where $3\%$ of the adjacent SNPs are $\geq 3kbp$ apart. The other distance bins brake points correspond to quantiles of the empirical distribution for distances that are $< 3kbp$.
