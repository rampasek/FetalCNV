...
\subfigure[]{ %\label{fig:histo:b}
	\begin{minipage}[b]{0.48\textwidth}
		\centering
	\includegraphics[width=0.98\textwidth]{figures/IpIm}
	\end{minipage}	
}
\end{figure*}
